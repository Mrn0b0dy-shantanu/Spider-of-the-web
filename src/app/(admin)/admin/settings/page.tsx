  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Configure global operational parameters and security.</p>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border bg-muted/30">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Currently connected to National SMS API.</p>
              </div>
